...
const DEFAULT_OPTIONS = {
  ...
  onlyOriginalIcon: 'film.circle.fill',
  onlyOriginalIconColor: '#B88CB2',
  onlyOriginalStyle: '',
  notAvailableContent: '不支持 Netflix',
  notAvailableIcon: 'film.circle.fill',
  notAvailableIconColor: '#B88CB2',
  notAvailableStyle: '',
  errorContent: '检测失败，请重试',
  errorIcon: 'film.circle.fill',
  errorIconColor: '#B88CB2',
  errorStyle: '',
}
